...
Public Class rptAppraisal1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HumanResources.rptAppraisal1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAppraisal1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAppraisal1 = New rptAppraisal1
        rpt.Site = Me.Site
        Return rpt
    End Function

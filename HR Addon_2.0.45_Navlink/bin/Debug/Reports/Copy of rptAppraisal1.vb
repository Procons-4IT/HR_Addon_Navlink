...
Public Class Copy_of_rptAppraisal1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy of rptAppraisal1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HumanResources.Copy of rptAppraisal1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_of_rptAppraisal1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_of_rptAppraisal1 = New Copy_of_rptAppraisal1()
        rpt.Site = Me.Site
        Return rpt
    End Function

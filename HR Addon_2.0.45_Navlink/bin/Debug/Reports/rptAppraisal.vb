...
Public Class rptAppraisal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HumanResources.rptAppraisal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAppraisal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAppraisal = New rptAppraisal()
        rpt.Site = Me.Site
        Return rpt
    End Function

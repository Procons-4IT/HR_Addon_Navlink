Public Class clshrMgrRegTrainApproval
    Inherits clsBase
    ...
    End Sub
    Public Sub LoadForm()
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_hr_MgrRegTrainApproval) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_hr_MgrRegTrainApproval, frm_hr_MgrRegTrainApproval)
        ...
        oApplication.Utilities.setUserDSCombobox(oForm, "62", "Status")
        ...
        oForm.Items.Item("62").DisplayDesc = True
        oForm.PaneLevel = 1
...
#End Region
    ...
    Private Sub ReceivedApplicants(ByVal aform As SAPbouiCOM.Form)
        ...
        strqry = strqry & " U_Z_Status ,U_Z_Remarks,U_Z_MgrRegStatus,U_Z_MgrRegRemarks,U_Z_HRRegStatus,U_Z_HrRegRemarks,Code from [@Z_HR_TRIN1] where U_Z_TrainCode='" & oApplication.Utilities.getEdittextvalue(aform, "13") & "' and " & strConiditon
        ...
        oCombobox = aform.Items.Item("62").Specific
        If oCombobox.Selected.Value = "O" Then
            ...
            ocombo.ValidValues.Add("R", "Rejected")
            ocombo.DisplayType = SAPbouiCOM.BoComboDisplayType.cdt_both
            oGrid.Columns.Item("U_Z_MgrRegStatus").Editable = True
            oGrid.Columns.Item("U_Z_MgrRegRemarks").TitleObject.Caption = "First Level Remarks"
            oGrid.Columns.Item("U_Z_MgrRegRemarks").Editable = True
        Else
            oGrid.Columns.Item("U_Z_MgrRegStatus").TitleObject.Caption = "Status"
            oGrid.Columns.Item("U_Z_MgrRegStatus").Type = SAPbouiCOM.BoGridColumnType.gct_ComboBox
            ocombo = oGrid.Columns.Item("U_Z_MgrRegStatus")
            ocombo.ValidValues.Add("P", "Pending")
            ocombo.ValidValues.Add("A", "Approved")
            ...
            oGrid.Columns.Item("U_Z_MgrRegRemarks").TitleObject.Caption = "Manager Remarks"
...
#Region "AddToUDT"
    Private Function AddToUDT(ByVal aForm As SAPbouiCOM.Form) As Boolean
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            strqry = "Update [@Z_HR_TRIN1] set  U_Z_MgrRegStatus='" & oGrid.DataTable.GetValue("U_Z_MgrRegStatus", intRow) & "',U_Z_MgrRegRemarks='" & oGrid.DataTable.GetValue("U_Z_MgrRegRemarks", intRow) & "' where U_Z_TrainCode='" & oApplication.Utilities.getEdittextvalue(aForm, "13") & "' and U_Z_HREmpID='" & strEmpId & "'"
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_hr_MgrRegTrainApproval Then
                    ...
                    Case True
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_CLICK
                                oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                If pVal.ItemUID = "57" And (pVal.ColUID = "U_Z_MgrRegStatus" Or pVal.ColUID = "U_Z_MgrRegRemarks") Then
                                    oGrid = oForm.Items.Item("57").Specific
                                    ocombo = oGrid.Columns.Item("U_Z_HRRegStatus")

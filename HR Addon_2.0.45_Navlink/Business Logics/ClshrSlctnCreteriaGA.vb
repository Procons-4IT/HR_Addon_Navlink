Public Class ClshrSlctnCreteriaGA
    Inherits clsBase
    ...
    Public Sub LoadForm(ByVal DocType As String)
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_hr_SlctnCrGA) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_hr_SlctnCreteriaGA, frm_hr_SlctnCrGA)
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_hr_SlctnCrGA Then
                                ...
                                If pVal.ItemUID = "6" Then
                                    If Validate(oForm) Then
                                        If (oApplication.Utilities.getEdittextvalue(oForm, "12") = "HR Acceptance") Then
                                            Dim oCombo1, oCombo2, oCombo3 As SAPbouiCOM.ComboBox

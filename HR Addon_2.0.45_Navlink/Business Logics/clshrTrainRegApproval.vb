Public Class clshrTrainRegApproval
    Inherits clsBase
    ...
    Public Sub LoadForm(ByVal oForm As SAPbouiCOM.Form)
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_hr_TrainRegApproval) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_hr_TrainRegApproval, frm_hr_TrainRegApproval)
        oForm = oApplication.SBO_Application.Forms.ActiveForm()
        oForm.Freeze(True)
        oForm.PaneLevel = 1
        oForm.DataSources.DataTables.Add("dtDocumentList")
        oForm.DataSources.DataTables.Add("dtHistoryList")
        oApplication.Utilities.InitializationApproval(oForm, HeaderDoctype.Train, HistoryDoctype.RegTra)
        oApplication.Utilities.ApprovalSummary(oForm, HeaderDoctype.Train, HistoryDoctype.RegTra)
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_hr_TrainRegApproval Then
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "_1" Then
                                    If oApplication.Utilities.ApprovalValidation(oForm, HistoryDoctype.RegTra) = False Then
                                        BubbleEvent = False
                                        Exit Sub
                                    End If
                                End If
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_MATRIX_LINK_PRESSED
                                ...
                                oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                If (pVal.ItemUID = "1" Or pVal.ItemUID = "19") And pVal.ColUID = "U_Z_TrainCode" Then
                                    oGrid = oForm.Items.Item(pVal.ItemUID).Specific
                                    For intRow As Integer = pVal.Row To pVal.Row
                                        If 1 = 1 Then
                                            oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                            strcode = oGrid.DataTable.GetValue("U_Z_TrainCode", intRow)
                                    ...
                                    Exit Sub
                                End If
                                If (pVal.ItemUID = "1" Or pVal.ItemUID = "19") And pVal.ColUID = "U_Z_CourseCode" Then
                                    oGrid = oForm.Items.Item(pVal.ItemUID).Specific
                                    For intRow As Integer = pVal.Row To pVal.Row
                                        If 1 = 1 Then
                                            oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                            strcode = oGrid.DataTable.GetValue("U_Z_CourseCode", intRow)
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "1" And pVal.ColUID = "RowsHeader" And pVal.Row > -1 Then
                                    ...
                                    oApplication.Utilities.LoadHistory(oForm, HistoryDoctype.RegTra, strDocEntry)
                                ...
                                ElseIf pVal.ItemUID = "_1" Then
                                    ...
                                    If intRet = 1 Then
                                        oApplication.Utilities.addUpdateDocument(oForm, HistoryDoctype.RegTra, HeaderDoctype.Train)
                                    End If
                                End If
                                If pVal.ItemUID = "19" And pVal.ColUID = "RowsHeader" And pVal.Row > -1 Then
                                    oGrid = oForm.Items.Item("19").Specific
                                    Dim strDocEntry As String = oGrid.DataTable.GetValue("Code", pVal.Row)
                                    oApplication.Utilities.SummaryHistory(oForm, HistoryDoctype.RegTra, strDocEntry)
                                End If

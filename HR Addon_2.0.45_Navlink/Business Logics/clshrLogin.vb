Public Class clshrLogin
    ...
    Public Sub LoadForm(ByVal aChoice As String)
        ...
        ElseIf aChoice = "BNKTME" Then
            EntryChoice = "Bank Time Request"
        End If
        ...
        ElseIf EntryChoice = "Leave Request" Then
            ...
            oForm.Items.Item("9").Visible = True
            oForm.Items.Item("10").Visible = True
        ElseIf EntryChoice = "Bank Time Request" Then
            oCombobox = oForm.Items.Item("8").Specific
            oCombobox.Select("BNKTME", SAPbouiCOM.BoSearchKey.psk_ByValue)
            oForm.Items.Item("3").Click(SAPbouiCOM.BoCellClickType.ct_Regular)
            oForm.Items.Item("8").Enabled = False
            oForm.Items.Item("9").Visible = True
            oForm.Items.Item("10").Visible = True
...
#Region "DataBind"
    Private Sub databind(ByVal aForm As SAPbouiCOM.Form)
        Try
            ...
            oCombobox.ValidValues.Add("BNKTME", "Bank Time Request")
...
#Region "validations"
    Private Function validation(ByVal aform As SAPbouiCOM.Form) As Boolean
        ...
        pwd = oApplication.Utilities.Encrypt(pwd, oApplication.Utilities.key)
        ...
        If EntryChoice = "EmpExpClaim" Then
            ...
            If otemp.RecordCount <= 0 Then
                ...
                Return False
            ElseIf ActionType = "V" Then
                Dim objct As New clshrExpClaimView
        ...
        If EntryChoice = "BNKTME" Then
            ...
            If otemp.RecordCount <= 0 Then
                ...
                Return False
            ElseIf ActionType = "V" Then
                Dim objct As New clshrBankTimeRequest
                strApprovalType = "BNKTME"
                objct.ViewLoadForm(otemp.Fields.Item(0).Value, otemp.Fields.Item(1).Value)
                Return True
            Else
                Dim objct As New clshrBankTimeRequest
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_COMBO_SELECT
                                ...
                                If pVal.ItemUID = "10" Then
                                    ...
                                    If oCombobox1.Selected.Value = "LVEREQ" Then
                                        ...
                                        oForm.Items.Item("12").Visible = False
                                    End If
                                    If oCombobox1.Selected.Value = "BNKTME" Then
                                        oForm.Items.Item("11").Visible = False
                                        oForm.Items.Item("12").Visible = False
                                    End If
                                    If oCombobox1.Selected.Value = "EmpExpClaim" Then
                                        oForm.Items.Item("11").Visible = False
                                        oForm.Items.Item("12").Visible = False
                                    End If
                                    'End If

Public Class clshrTravelApproval
    Inherits clsBase
    ...
    Public Sub LoadForm(ByVal oForm As SAPbouiCOM.Form)
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_hr_TravelApproval) = False Then
            ...
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_hr_TraApproval, frm_hr_TravelApproval)
        oForm = oApplication.SBO_Application.Forms.ActiveForm()
        oForm.Freeze(True)
        oForm.PaneLevel = 1
        oForm.DataSources.DataTables.Add("dtDocumentList")
        oForm.DataSources.DataTables.Add("dtHistoryList")
        oApplication.Utilities.InitializationApproval(oForm, HeaderDoctype.TraReq, HistoryDoctype.TraReq)
        oApplication.Utilities.ApprovalSummary(oForm, HeaderDoctype.TraReq, HistoryDoctype.TraReq)
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_hr_TravelApproval Then
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "1" And pVal.ColUID = "RowsHeader" And pVal.Row > -1 Then
                                    ...
                                    oApplication.Utilities.LoadHistory(oForm, HistoryDoctype.TraReq, strDocEntry)
                                ...
                                ElseIf pVal.ItemUID = "_1" Then
                                    ...
                                    If intRet = 1 Then
                                        oApplication.Utilities.addUpdateDocument(oForm, HistoryDoctype.TraReq, HeaderDoctype.TraReq)
                                    End If
                                End If
                                If pVal.ItemUID = "19" And pVal.ColUID = "RowsHeader" And pVal.Row > -1 Then
                                    oGrid = oForm.Items.Item("19").Specific
                                    Dim strDocEntry As String = oGrid.DataTable.GetValue("DocEntry", pVal.Row)
                                    oApplication.Utilities.SummaryHistory(oForm, HistoryDoctype.TraReq, strDocEntry)
                                End If

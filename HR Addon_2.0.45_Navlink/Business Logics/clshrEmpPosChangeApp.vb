Public Class clshrEmpPosChangeApp
    Inherits clsBase
    ...
    Public Sub LoadForm(ByVal oForm As SAPbouiCOM.Form)
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_hr_EmpPosChApp) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_HR_EmpPosChApp, frm_hr_EmpPosChApp)
        oForm = oApplication.SBO_Application.Forms.ActiveForm()
        oForm.Freeze(True)
        oForm.PaneLevel = 1
        oForm.DataSources.DataTables.Add("dtDocumentList")
        oForm.DataSources.DataTables.Add("dtHistoryList")
        oApplication.Utilities.InitializationApproval(oForm, HeaderDoctype.EmpLife, HistoryDoctype.EmpPos)
        oApplication.Utilities.ApprovalSummary(oForm, HeaderDoctype.EmpLife, HistoryDoctype.EmpPos)
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_hr_EmpPosChApp Then
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "_1" Then
                                    If oApplication.Utilities.ApprovalValidation(oForm, HistoryDoctype.EmpPos) = False Then
                                        BubbleEvent = False
                                        Exit Sub
                                    End If
                                End If
                            Case SAPbouiCOM.BoEventTypes.et_MATRIX_LINK_PRESSED
                                'If pVal.ItemUID = "1" And pVal.ColUID = "DocEntry" Then
                                '    oGrid = oForm.Items.Item("1").Specific
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "1" And pVal.ColUID = "RowsHeader" And pVal.Row > -1 Then
                                    ...
                                    oApplication.Utilities.LoadHistory(oForm, HistoryDoctype.EmpPos, strDocEntry)
                                ...
                                ElseIf pVal.ItemUID = "_1" Then
                                    ...
                                    If intRet = 1 Then
                                        oApplication.Utilities.addUpdateDocument(oForm, HistoryDoctype.EmpPos, HeaderDoctype.EmpLife)
                                    End If
                                End If
                                If pVal.ItemUID = "19" And pVal.ColUID = "RowsHeader" And pVal.Row > -1 Then
                                    oGrid = oForm.Items.Item("19").Specific
                                    Dim strDocEntry As String = oGrid.DataTable.GetValue("Code", pVal.Row)
                                    oApplication.Utilities.SummaryHistory(oForm, HistoryDoctype.EmpPos, strDocEntry)
                                End If

        ...
        Try
           ...
           ' prodt = prodt.AddDays(-1)
            ...
            Else
                ...
                If intTempID <> "0" Then
                    oApplication.Utilities.UpdateApprovalRequired("@Z_HR_HEM4", "Code", strCode, "Y", intTempID)
                    oApplication.Utilities.InitialMessage("Position Change Request", strCode, oApplication.Utilities.DocApproval(aForm, HeaderDoctype.EmpLife, strDeptCode), intTempID, strEmpName, HistoryDoctype.EmpPos)
                Else
                    oApplication.Utilities.UpdateApprovalRequired("@Z_HR_HEM4", "Code", strCode, "N", intTempID)
                End If

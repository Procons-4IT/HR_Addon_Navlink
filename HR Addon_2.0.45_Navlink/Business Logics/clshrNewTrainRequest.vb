            ...
            If BusinessObjectInfo.BeforeAction = False And BusinessObjectInfo.ActionSuccess = True And (BusinessObjectInfo.EventType = SAPbouiCOM.BoEventTypes.et_FORM_DATA_ADD) Then
                ...
                If stXML <> "" Then
                    ...
                    If otest.RecordCount > 0 Then
                        ...
                        If intTempID <> "0" Then
                            oApplication.Utilities.UpdateApprovalRequired("@Z_HR_ONTREQ", "DocEntry", otest.Fields.Item("DocEntry").Value, "Y", intTempID)
                        ...
                        Else
                            oApplication.Utilities.UpdateApprovalRequired("@Z_HR_ONTREQ", "DocEntry", otest.Fields.Item("DocEntry").Value, "N", intTempID)
                        End If
                    End If

Imports System.IO
Public Class clshrASCanSelectionSe
    Inherits clsBase
    ...
    Private Sub LoadForm(ByVal intType As Int16, ByVal Title As String)
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_hr_CReqSelectionSe) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_hr_CReqSelectionSe, frm_hr_CReqSelectionSe)
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_hr_CReqSelectionSe Then

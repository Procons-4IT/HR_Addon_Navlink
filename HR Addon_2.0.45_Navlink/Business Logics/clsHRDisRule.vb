...
#Region "Item Event"
    ...
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        BubbleEvent = True
        If pVal.FormTypeEx = frm_HRDisRule Then
                    ...
                    Select Case pVal.EventType
                        ...
                        Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                            ...
                            If pVal.ItemUID = "3" Then
                                ...
                                stvalue = oApplication.Utilities.getEdittextvalue(oForm, "ed4")
                                ...
                                If frmSourceForm.TypeEx = frm_hr_TraAgenda Then
                                ...
                                If frmSourceForm.TypeEx = frm_hr_EmpMaster Then
                                    oedit = frmSourceForm.Items.Item(ItemUID).Specific
                                    oApplication.Utilities.setEdittextvalue(frmSourceForm, ItemUID, stvalue)
                                End If

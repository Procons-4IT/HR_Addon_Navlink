...
#Region "For LineManager"
    Private Sub ForLineManager(ByVal DocNo As Integer, ByVal iFun As Integer, ByVal LMStatus As String, ByVal HODStatus As String, ByVal HRStatus As String)
        ...
        oGCol23 = oGridDetail.Columns.Item("Rating Description")
...
#Region "LineManager DIAPI"
    Private Function LineManager_DIAPI(ByVal DocNo As String, ByVal strApplicantID As String, ByVal oDT As DataTable, ByVal iFunction As Integer, ByVal oHT As Hashtable) As Boolean
        ...
        Try
            ...
            Dim strInterviewsummerystatus As String = "P"
            If oHT.Count > 0 Then
            ...
            For i As Integer = 0 To oDT.Rows.Count - 1
                ...
                ElseIf iFunction = 2 Then
                    ...
                    oChildData.SetProperty("U_Z_RatingDesc", odr("RatingDesc").ToString())
                    ...
                    strInterviewsummerystatus = odr("Status").ToString

                End If
            Next
            oGenService.Update(oGenData)

            'U_Z_RatingDesc as 'Rating Description',
            ...
            If strFunction = "IPLM" Then
                If iFunction = 1 Then
                    sQuery = "Update [@Z_HR_OHEM1] Set U_Z_FinalApproval = 'N' Where DocEntry = '" & DocNo & "'"
                    oRec.DoQuery(sQuery)
                End If
              
            Else
                If iFunction = 2 Then
                    If strInterviewsummerystatus <> "P" And strInterviewsummerystatus <> "-" Then
                        sQuery = "Update [@Z_HR_OHEM1] Set U_Z_FinalApproval = 'Y' Where isnull(U_Z_FinalApproval,'N')='N' and  DocEntry = '" & DocNo & "'"
                        oRec.DoQuery(sQuery)
                    End If
                End If
            End If
                                ...
                                ElseIf pVal.ItemUID = "5" And pVal.ColUID = "Rating" Then
                                    ...
                                    Try
                                        ...
                                        If (oCFLEvento.BeforeAction = False) Then
                                            ...
                                            Dim Val3 As String = oDataTable.GetValue("U_Z_RateName", 0)
                                            Try
                                                oGridDetail.DataTable.Columns.Item("Rating").Cells.Item(pVal.Row).Value = val1
                                                oGridDetail.DataTable.Columns.Item("Rating Description").Cells.Item(pVal.Row).Value = Val3
                                        ...
                                        Case "IPLM"
                                            ...
                                            If oGrid.Rows.Count > 0 Then
                                                ...
                                                If oGridDetail.Rows.Count > 0 Then
                                                    ...
                                                    oDT_DIAPI.Columns.Add("RatingDesc")
                                                    ...
                                                    For i As Integer = 0 To oGridDetail.Rows.Count - 1
                                                        If 1 = 1 Then
                                                            ...
                                                            Else
                                                                ...
                                                                dr.Item("RatingDesc") = oGridDetail.DataTable.Columns.Item("Rating Description").Cells.Item(i).Value.ToString()
            ...
            For Each dr As DataRow In oDT_DIAPI.Rows
                If Not IsDBNull(dr(0)) Then
                    If dr(0) <> "-" And String.IsNullOrEmpty(dr(1)) Then
                        ...
                        _retVal = False
                        Exit For
                    ElseIf dr("SID") = "" Or String.IsNullOrEmpty(dr("SID")) Then

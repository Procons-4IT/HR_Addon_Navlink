Public Class clshrPromotion
    ...
    Private Sub Gridbind(ByVal strempid As String, ByVal aForm As SAPbouiCOM.Form)
        ...
        strqry = "	select ""Code"", ""U_Z_EmpId"",""U_Z_DeptName"",""U_Z_PosCode"",""U_Z_PosName"",""U_Z_JobCode"",""U_Z_JobName"",""U_Z_OrgCode"",""U_Z_OrgName"",""U_Z_SalCode"",""U_Z_UnitCode"" ""UnitCode"",""U_Z_UnitName"" ""Unit Name"","
...
#Region "AddToUDT"
    Private Function AddToUDTPromotion(ByVal aForm As SAPbouiCOM.Form) As Boolean
        ...
        strEmpName = otemp2.Fields.Item("EmName").Value
        ...
        Try
            ...
            oUserTable.UserFields.Fields.Item("U_Z_UnitCode").Value = oApplication.Utilities.getEdittextvalue(oForm, "87")
            oUserTable.UserFields.Fields.Item("U_Z_UnitName").Value = oApplication.Utilities.getEdittextvalue(oForm, "88")
            ...
            Else
                ...
                Dim intTempID As String = oApplication.Utilities.GetTemplateID(aForm, HeaderDoctype.EmpLife, strDeptCode)
                If intTempID <> "0" Then
                    oApplication.Utilities.UpdateApprovalRequired("@Z_HR_HEM2", "Code", strCode, "Y", intTempID)
                    oApplication.Utilities.InitialMessage("Promotion Change Request", strCode, oApplication.Utilities.DocApproval(aForm, HeaderDoctype.EmpLife, strDeptCode), intTempID, strEmpName, HistoryDoctype.EmpPro)
                Else

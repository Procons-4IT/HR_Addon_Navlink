Public Class clshrRecOverview
    ...
    End Sub
    Public Sub LoadForm()
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_hr_RecOverview) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_hr_RecOverview, frm_hr_RecOverview)
    ...
    Private Sub Gridbind1(ByVal aform As SAPbouiCOM.Form)
        ...
        If oGrid.Rows.Count > 0 Then
            ...
            DocNo = Convert.ToInt32(oGrid.DataTable.GetValue("DocEntry", 0))
        End If
...
#End Region
    ...
    Public Sub ResizeMatrix(ByVal sboForm As SAPbouiCOM.Form)
        Try
            ...
            Dim sboItem As SAPbouiCOM.Item = sboForm.Items.Item("43")
            sboItem.Top = 8
            sboItem.Height = 200
            ' sboItem.Width = sboForm.Width - 30 'Adjust the matrix width to fit the new form size 

            sboItem = sboForm.Items.Item("28")
            sboItem.Top = sboForm.Items.Item("43").Height + 20

            sboItem = sboForm.Items.Item("29")
            sboItem.Top = sboForm.Items.Item("43").Height + 20

            ' sboItem.Left = sboForm.Items.Item("43").Width + 50

            sboItem = sboForm.Items.Item("44")
            sboItem.Top = sboForm.Items.Item("28").Top + 20
            sboItem.Height = 150
            sboItem.Width = sboForm.Width / 2.5

            sboItem = sboForm.Items.Item("45")
            sboItem.Top = sboForm.Items.Item("28").Top + 20
            sboItem.Left = sboForm.Items.Item("44").Width + 20
            sboItem.Height = 150
            sboItem.Width = sboForm.Items.Item("44").Width
            sboItem = sboForm.Items.Item("29")
            sboItem.Left = sboForm.Items.Item("45").Left
        ...
        sboForm.Freeze(False)
    End Sub
    Public Sub ResizeMatrix1(ByVal sboForm As SAPbouiCOM.Form)
        Try
            sboForm.Freeze(True)
            ' Reset the height of the matrix to prevent it growing during form resize
            Dim sboItem As SAPbouiCOM.Item = sboForm.Items.Item("43")
            ...
            sboItem = sboForm.Items.Item("29")
            sboItem.Top = sboForm.Items.Item("43").Height + 20
            ' sboItem.Left = sboForm.Items.Item("43").Left + 50


            sboItem = sboForm.Items.Item("44")
            sboItem.Top = sboForm.Items.Item("28").Top + 50
            sboItem.Height = 150
            sboItem.Width = sboForm.Width / 2.5

            sboItem = sboForm.Items.Item("45")
            sboItem.Top = sboForm.Items.Item("29").Top + 50
            sboItem.Left = sboForm.Items.Item("44").Width + 20
            sboItem.Height = 150
            sboItem.Width = sboForm.Items.Item("44").Width
            sboItem = sboForm.Items.Item("29")
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_hr_RecOverview Then
                                ...
                                If pVal.ItemUID = "43" And pVal.ColUID = "DocEntry" Then
                                    ...
                                    For intRow As Integer = pVal.Row To pVal.Row
                                        If 1 = 1 Then
                                            ...
                                            If oForm.Title = "Recruitment Overview" Then
                                                Dim objct As New clshrMPRequest
                                                objct.LoadForm1(strCode, oForm.Title, , , )
                                            Else
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                Select Case pVal.ItemUID
                                    ...
                                    Case "7"
                                        oGrid = oForm.Items.Item("43").Specific
                                        If oApplication.SBO_Application.MessageBox("Do you want confirm the Recruitment Closing", , "Yes", "No") = 2 Then
                                            Exit Sub

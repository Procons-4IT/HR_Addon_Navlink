Public Class clshrBankTimeApproval
    Inherits clsBase
    ...
    Public Sub LoadForm(ByVal oForm As SAPbouiCOM.Form)
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_hr_BnkTmeApproval) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If
        oForm = oApplication.Utilities.LoadForm(xml_hr_BnkTmeApproval, frm_hr_BnkTmeApproval)
        oForm = oApplication.SBO_Application.Forms.ActiveForm()
        oForm.Freeze(True)
        oForm.PaneLevel = 1
        oForm.DataSources.DataTables.Add("dtDocumentList")
        oForm.DataSources.DataTables.Add("dtHistoryList")
        oApplication.Utilities.InitializationApproval(oForm, HeaderDoctype.LveReq, HistoryDoctype.BankTime)
        oApplication.Utilities.ApprovalSummary(oForm, HeaderDoctype.LveReq, HistoryDoctype.BankTime)
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_hr_BnkTmeApproval Then
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "_1" Then
                                    If oApplication.Utilities.ApprovalValidation(oForm, HistoryDoctype.TraReq) = False Then
                                        BubbleEvent = False
                                        Exit Sub
                                    End If
                                End If
                            Case SAPbouiCOM.BoEventTypes.et_MATRIX_LINK_PRESSED
                                ...
                                If (pVal.ItemUID = "1" Or pVal.ItemUID = "19") And pVal.ColUID = "Code" Then
                                    ...
                                    Dim objHistory As New clshrBankTimeRequest
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "1" And pVal.ColUID = "RowsHeader" And pVal.Row > -1 Then
                                    ...
                                    oApplication.Utilities.LoadHistory(oForm, HistoryDoctype.BankTime, strDocEntry)
                                ...
                                ElseIf pVal.ItemUID = "_1" Then
                                    ...
                                    If intRet = 1 Then
                                        oApplication.Utilities.addUpdateDocument(oForm, HistoryDoctype.BankTime, HeaderDoctype.LveReq)
                                    End If
                                End If
                                If pVal.ItemUID = "19" And pVal.ColUID = "RowsHeader" And pVal.Row > -1 Then
                                    oGrid = oForm.Items.Item("19").Specific
                                    Dim strDocEntry As String = oGrid.DataTable.GetValue("Code", pVal.Row)
                                    oApplication.Utilities.SummaryHistory(oForm, HistoryDoctype.BankTime, strDocEntry)
                                End If
